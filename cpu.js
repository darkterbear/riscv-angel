...
function CPU(memamt) {
  ...
  console.log(PCR['CSR_MSTATUS'])
  this.priv_reg[PCR['CSR_MSTATUS']['num']] = status_reg_init()
  ...
  function store_double_to_mem(addr, val) {
    var vmOn = (this.priv_reg[PCR['CSR_MSTATUS']['num']] & SR['SR_VM']) != 0x0
    if (vmOn) {
