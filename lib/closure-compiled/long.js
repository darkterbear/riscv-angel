...
goog.math.Long.fromNumber = function(a) {
	return isNaN(a) || !isFinite(a)
		...
		: new goog.math.Long(
				a % goog.math.Long.TWO_PWR_32_DBL_ | 0,
				(a / goog.math.Long.TWO_PWR_32_DBL_) | 0
		  )
}
...
goog.math.Long.fromString = function(a, b) {
	...
	for (
		...
		8 > g
			? ((g = goog.math.Long.fromNumber(Math.pow(c, g))),
			  (e = e.multiply(g).add(goog.math.Long.fromNumber(k))))
			: ((e = e.multiply(d)), (e = e.add(goog.math.Long.fromNumber(k))))
	}
	return e
}
...
goog.math.Long.prototype.toString = function(a) {
	...
	for (
		var c = goog.math.Long.fromNumber(Math.pow(a, 6)), b = this, d = '';
		;

	) {
		var e = b.div(c),
			f = b
				.subtract(e.multiply(c))
				.toInt()
				.toString(a),
			b = e
...
goog.math.Long.prototype.div = function(a) {
	...
	for (var d = goog.math.Long.ZERO, c = this; c.greaterThanOrEqual(a); ) {
		for (
			var b = Math.max(1, Math.floor(c.toNumber() / a.toNumber())),
				e = Math.ceil(Math.log(b) / Math.LN2),
				e = 48 >= e ? 1 : Math.pow(2, e - 48),
				f = goog.math.Long.fromNumber(b),
				g = f.multiply(a);
			g.isNegative() || g.greaterThan(c);
...
goog.math.Long.prototype.shiftLeft = function(a) {
	...
	var b = this.low_
	return 32 > a
		? goog.math.Long.fromBits(b << a, (this.high_ << a) | (b >>> (32 - a)))
		: goog.math.Long.fromBits(0, b << (a - 32))
}
goog.math.Long.prototype.shiftRight = function(a) {
	...
	var b = this.high_
	return 32 > a
		? goog.math.Long.fromBits((this.low_ >>> a) | (b << (32 - a)), b >> a)
		: goog.math.Long.fromBits(b >> (a - 32), 0 <= b ? 0 : -1)
}
