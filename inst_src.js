function check_HTIF() {
  ...
  if (toHostVal.high_ != 0 || toHostVal.low_ != 0) {
    ...
    var payload = new Long(
      toHostVal.getLowBits(),
    ...
    if (device == 0x1) {
      ...
      if (cmd == 0x0) {
        ...
        for (var i = 0; i < toWrite.length; i++) {
          RISCV.memory[(addr.getLowBits() + i) >> 2] &= ~(
            0xff <<
            ((i & 0x3) << 3)
          )
          RISCV.memory[(addr.getLowBits() + i) >> 2] |=
            (toWrite.charCodeAt(i) & 0xff) << ((i & 0x3) << 3)
        }
        // null term if null term would go in new word
        RISCV.memory[(addr.getLowBits() + toWrite.length) >> 2] &= ~(
          0xff <<
...
function runInstruction(raw) {
  ...
  switch (op) {
    ...
    case 0x13:
      ...
      switch (funct3) {
        ...
        // SLLI
        case 0x1:
          RISCV.gen_reg[inst.get_rd()] = RISCV.gen_reg[
            inst.get_rs1()
          ].shiftLeft(inst.get_I_imm() & 0x003f)
          RISCV.pc += 4
          break
        ...
        case 0x2:
          if (
            RISCV.gen_reg[inst.get_rs1()].lessThan(
              signExtLT32_64(inst.get_I_imm())
            )
          ) {
        ...
        case 0x5:
          ...
          if (aldiff === 0) {
            ...
            RISCV.gen_reg[inst.get_rd()] = RISCV.gen_reg[
              inst.get_rs1()
            ].shiftRightUnsigned(inst.get_I_imm() & 0x003f)
          } else {
            // SRAI
            RISCV.gen_reg[inst.get_rd()] = RISCV.gen_reg[
              inst.get_rs1()
            ].shiftRight(inst.get_I_imm() & 0x003f)
          }
          RISCV.pc += 4
          break
    ...
    case 0x33:
      ...
      switch (funct10) {
        ...
        case 0x1:
          RISCV.gen_reg[inst.get_rd()] = RISCV.gen_reg[
            inst.get_rs1()
          ].shiftLeft(RISCV.gen_reg[inst.get_rs2()].getLowBits() & 0x3f)
          RISCV.pc += 4
          break
        ...
        case 0x105:
          RISCV.gen_reg[inst.get_rd()] = RISCV.gen_reg[
            inst.get_rs1()
          ].shiftRight(RISCV.gen_reg[inst.get_rs2()].getLowBits() & 0x3f)
          RISCV.pc += 4
          break
        ...
        case 0xc:
          if (RISCV.gen_reg[inst.get_rs2()].isZero()) {
            ...
            RISCV.gen_reg[inst.get_rs1()].equals(new Long(0x0, 0x80000000)) &&
    ...
    case 0x17:
      ...
      if (
        (RISCV.gen_reg[inst.get_rd()].getLowBitsUnsigned() & 0xff000000) ==
        0x55000000
      ) {
        RISCV.gen_reg[inst.get_rd()] = new Long(
          RISCV.gen_reg[inst.get_rd()].getLowBitsUnsigned(),
          0x155
        )
      }
      RISCV.pc += 4
    ...
    case 0x63:
      ...
      switch (funct3) {
        ...
        case 0x0:
          if (
            RISCV.gen_reg[inst.get_rs1()].equals(RISCV.gen_reg[inst.get_rs2()])
          ) {
        ...
        case 0x1:
          if (
            RISCV.gen_reg[inst.get_rs1()].notEquals(
              RISCV.gen_reg[inst.get_rs2()]
            )
          ) {
            RISCV.pc = (RISCV.pc | 0) + inst.get_B_imm()
        ...
        case 0x5:
          if (
            RISCV.gen_reg[inst.get_rs1()].greaterThanOrEqual(
              RISCV.gen_reg[inst.get_rs2()]
            )
          ) {
            RISCV.pc = (RISCV.pc | 0) + inst.get_B_imm()
    ...
    case 0x67:
      ...
      if (funct3 == 0x0) {
        RISCV.gen_reg[inst.get_rd()] = signExtLT32_64(RISCV.pc + 4)
        RISCV.pc =
          inst.get_I_imm() + (RISCV.gen_reg[inst.get_rs1()].getLowBits() | 0)
      } else {
        throw new RISCVTrap('Illegal Instruction')
      }
      break
    ...
    case 0x73:
      var superfunct =
        inst.get_funct3() | (inst.get_rs2() << 3) | (inst.get_funct7() << 8)
      switch (superfunct) {
        // SCALL
        case 0x0:
        ...
        case 0x4000:
          ...
          //                    if ((RISCV.priv_reg[PCR["CSR_MSTATUS"]["num"]] & SR["SR_S"]) == 0) {
          //                        throw new RISCVTrap("Privileged Instruction");
          //                    }
          // do eret stuff here
          var oldsr = RISCV.priv_reg[PCR['CSR_MSTATUS']['num']]
          ...
          RISCV.priv_reg[PCR['CSR_MSTATUS']['num']] = oldsr
        ...
        case 0x6002:
          RISCV.gen_reg[inst.get_rd()] = new Long(
            RISCV.priv_reg[PCR['CSR_CYCLE']['num']],
            0x0
          )
          RISCV.pc += 4
          break
        ...
        case 0x600a:
          ...
          var result =
            nowtime - RISCV.priv_reg[PCR['CSR_TIME']['num']].toNumber()
        ...
        case 0x6012:
          ...
          RISCV.gen_reg[inst.get_rd()] =
            RISCV.priv_reg[PCR['CSR_INSTRET']['num']]
          RISCV.pc += 4
          break
      ...
      switch (funct10) {
        ...
        case 0xc:
          if (RISCV.gen_reg[inst.get_rs2()].isZero()) {
            ...
            RISCV.gen_reg[inst.get_rs1()].getLowBits() == 0xffffffff &&
        ...
        case 0xd:
          if (RISCV.gen_reg[inst.get_rs2()].isZero()) {
            ...
            RISCV.gen_reg[inst.get_rd()] = signExtLT32_64(
              (signed_to_unsigned(RISCV.gen_reg[inst.get_rs1()].getLowBits()) /
                signed_to_unsigned(
                  RISCV.gen_reg[inst.get_rs2()].getLowBits()
                )) |
                0
        ...
        case 0xf:
          if (RISCV.gen_reg[inst.get_rs2()].isZero()) {
            ...
            RISCV.gen_reg[inst.get_rd()] = signExtLT32_64(
              signed_to_unsigned(RISCV.gen_reg[inst.get_rs1()].getLowBits()) %
                signed_to_unsigned(RISCV.gen_reg[inst.get_rs2()].getLowBits()) |
                0
            )
          }
          RISCV.pc += 4
    ...
    case 0x2f:
      ...
      switch (funct8) {
        ...
        case 0xc2:
          ...
          if (
            signed_to_unsigned(rd_temp.getLowBitsUnsigned()) >
            signed_to_unsigned(
        ...
        case 0xc3:
          ...
          if (
            !long_less_than_unsigned(rd_temp, RISCV.gen_reg[inst.get_rs2()])
          ) {
            var temp = RISCV.gen_reg[inst.get_rs2()]
          } else {
            var temp = rd_temp
  ...
  RISCV.priv_reg[PCR['CSR_MCYCLE']['num']] += 1
}
